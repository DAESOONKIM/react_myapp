  ...
  return (
    <div className='w-10/12 flex justify-center items-center'>
        <div className="grid grid-cols-3 gap-4">
            ...
            <div>
                <TailButton caption='컴포넌트 변수' bcolor='blue' handleClick={handleC}></TailButton>
            </div>
            <div>
                <TailButton caption='State 변수' bcolor='orange' handleClick={handleS}></TailButton>
            </div>
            <div>
                <TailButton caption='Ref 변수' bcolor='lime' handleClick={handleR}></TailButton>
            </div>
        </div>
    </div>
  )
